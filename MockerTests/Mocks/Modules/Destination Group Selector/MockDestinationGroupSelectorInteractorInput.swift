//
//  MockDestinationGroupSelectorInteractorInput.swift
//  Mocker
//
...
class MockDestinationGroupSelectorInteractorInput: DestinationGroupSelectorInteractorInputProtocol {

    var presenter: DestinationGroupSelectorInteractorOutputProtocol?
...
extension MockDestinationGroupSelectorInteractorInput.Method: CustomStringConvertible {
...
extension MockDestinationGroupSelectorInteractorInput.MethodParameter: CustomStringConvertible {
    var description: String {
        var value = "["
        var first = true
        func handleFirst() {

...
//
//  MockMockFileParametersPresenter.swift
//  Mocker
//
...
class MockMockFileParametersPresenter: MockFileParametersPresenterProtocol {
...
extension MockMockFileParametersPresenter.Method: CustomStringConvertible {
...
extension MockMockFileParametersPresenter.MethodParameter: CustomStringConvertible {
    var description: String {
        var value = "["
        var first = true
        func handleFirst() {

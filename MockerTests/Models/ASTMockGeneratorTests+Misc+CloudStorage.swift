...
extension ASTMockGeneratorTests {
    ...
    func testCodeGeneration_cloudStorageProtocol_trackPropertyActivityFALSE_publicFALSE() throws {
    ...
    func testCodeGeneration_cloudStorageProtocol_trackPropertyActivityFALSE_publicTRUE() throws {
        let decl = try XCTUnwrap(protocolDeclaration(for: cloudStorageProtocol))

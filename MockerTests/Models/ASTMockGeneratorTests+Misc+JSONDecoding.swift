...
extension ASTMockGeneratorTests {
    ...
    func testCodeGeneration_jsonDecodingProtocol_trackPropertyActivityFALSE_publicFALSE() throws {
    ...
    func testCodeGeneration_jsonDecodingProtocol_trackPropertyActivityFALSE_publicTRUE() throws {
        let decl = try XCTUnwrap(protocolDeclaration(for: jsonDecodingProtocol))

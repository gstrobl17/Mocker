...
extension ASTMockGeneratorTests {
    ...
    func testCodeGeneration_notificationCenterProtocol_trackPropertyActivityFALSE_publicFALSE() throws {
    ...
    func testCodeGeneration_notificationCenterProtocol_trackPropertyActivityFALSE_publicTRUE() throws {
        let decl = try XCTUnwrap(protocolDeclaration(for: notificationCenterProtocol))
